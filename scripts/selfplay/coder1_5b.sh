...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/1_5b_coder_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/1_5b_coder_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/1_5b_coder_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    actor_rollout_ref.model.path=Qwen/Qwen2.5-Coder-1.5B \
    ...
    trainer.experiment_name='azr_coder1_5b' \
    ...
    azr.seed_dataset=data/1_5b_coder_seed_io.jsonl \
    azr.output_seed_path=data/1_5b_coder_seed_io.jsonl \
    azr.error_seed_dataset=data/1_5b_coder_error_seed_io.jsonl \
    azr.output_error_seed_path=data/1_5b_coder_error_seed_io.jsonl \
    azr.code_f_seed_dataset=data/1_5b_coder_code_f_seed_io.jsonl \
    azr.output_code_f_seed_path=data/1_5b_coder_code_f_seed_io.jsonl \
