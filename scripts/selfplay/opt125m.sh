...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/opt125m_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/opt125m_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/opt125m_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    azr.data_selection_strategy.content_max_length=800 \
    ...
    trainer.experiment_name='azr_opt125m' \
    ...
    azr.data_selection_strategy.max_programs=512 \
